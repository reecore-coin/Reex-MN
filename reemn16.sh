...
COIN_REPO='https://github.com/reecore-coin/Reex/'
COIN_TGZ=$(curl -s https://api.github.com/repos/reecore-coin/Reex/releases/latest | grep "browser_download_url.*\.tar\.gz"| cut -d '"' -f 4)
...
purgeOldInstallation() {
    ...
    #kill wallet daemon
    sudo systemctl stop Reecore > /dev/null 2>&1
